...
const MESTRE_BASE_URL = process.env.MESTRE_LAUNCHER_URL || "http://localhost:7777";
...
const OLLAMA_URL = process.env.MESTRE_OLLAMA_URL || "http://localhost:11434";

const OLLAMA_MODEL = process.env.MESTRE_OLLAMA_MODEL || "qwen2.5:1.5b";
